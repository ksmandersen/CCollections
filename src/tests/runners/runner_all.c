...
extern void test_can_create_sorted_list(void);
...
void test_sorted_list() {
	...
	RUN_TEST(test_can_create_sorted_list, 1);
	RUN_TEST(test_can_create_sorted_list, 2);
	RUN_TEST(test_can_add_objects, 3);
	RUN_TEST(test_will_sort_inserted_objects, 4);
	RUN_TEST(test_contains_will_return_true_for_contained_objects, 5);
	RUN_TEST(test_contains_will_return_false_for_non_contained_objects, 6);
	RUN_TEST(test_can_clear_list, 7);
	RUN_TEST(test_can_merge_lists, 8);
	RUN_TEST(test_can_enumerate_list, 9);
}
