...
void test_elements_in_list(cc_array_list *list) {
  int i = 1;
  cc_enumerator *e = cc_array_list_get_enumerator(list);
  while(cc_enumerator_move_next(e)) {
    cc_object *obj = cc_enumerator_current(e);
...
void test_can_add_objects_to_end_of_array_list(void) {
  ...
  cc_array_list_add_last(a_list, ins1);
  TEST_ASSERT_EQUAL(1, cc_object_int_value(cc_array_list_get_last(a_list)));

  cc_array_list_add_last(a_list, ins2);
  TEST_ASSERT_EQUAL(2, cc_object_int_value(cc_array_list_get_last(a_list)));

  cc_array_list_add_last(a_list, ins3);
...
void test_can_add_objects_to_array_list_with_index(void) {
  ...
  TEST_ASSERT_EQUAL(7283, cc_object_int_value(cc_array_list_get(a_list, 49)));
  TEST_ASSERT_EQUAL(49, cc_object_int_value(cc_array_list_get(a_list, 48)));
  TEST_ASSERT_EQUAL(50, cc_object_int_value(cc_array_list_get(a_list, 50)));
...
void test_can_add_objects_to_front_of_array_list(void) {
  ...
  cc_array_list_add_first(a_list, ins1);
  TEST_ASSERT_EQUAL(1, cc_object_int_value(cc_array_list_get_first(a_list)));

  cc_array_list_add_first(a_list, ins2);
  TEST_ASSERT_EQUAL(2, cc_object_int_value(cc_array_list_get_first(a_list)));

  cc_array_list_add_first(a_list, ins3);
  TEST_ASSERT_EQUAL(3, cc_object_int_value(cc_array_list_get_first(a_list)));

  TEST_ASSERT_EQUAL(3, cc_object_int_value(cc_array_list_get(a_list, 0)));
  TEST_ASSERT_EQUAL(2, cc_object_int_value(cc_array_list_get(a_list, 1)));
  TEST_ASSERT_EQUAL(1, cc_object_int_value(cc_array_list_get(a_list, 2)));
  TEST_ASSERT_EQUAL(3, cc_array_list_length(a_list));
}
...
void test_can_add_and_get_identical_objects_from_array_list(void)
{
  ...
  TEST_ASSERT_EQUAL(true, cc_object_is_equal(obj, cc_array_list_get_last(a_list)));
...
void test_getting_object_from_array_list_empty_array_list_returns_null(void) {
  ...
  TEST_ASSERT_EQUAL(NULL, cc_array_list_get_first(a_list));
  TEST_ASSERT_EQUAL(NULL, cc_array_list_get_last(a_list));
}
...
void test_can_remove_object_from_array_list_with_index(void) {
  ...
  TEST_ASSERT_EQUAL(67, cc_object_int_value(cc_array_list_get(a_list, 66)));
  TEST_ASSERT_EQUAL(69, cc_object_int_value(cc_array_list_get(a_list, 67)));
...
void test_can_remove_object_from_end_of_array_list(void) {
  ...
  TEST_ASSERT_EQUAL(99, cc_object_int_value(cc_array_list_get_last(a_list)));
  TEST_ASSERT_EQUAL(99, cc_array_list_length(a_list));
}
...
void test_removing_non_existing_index_from_array_list_does_nothing(void) {
  ...
  TEST_ASSERT_EQUAL(100, cc_array_list_length(a_list));
...
void test_can_merge_array_lists_together(void)
{
  ...
  cc_array_list_add_last(list1, val1);
  cc_array_list_add_last(list1, val2);
  cc_array_list_add_last(list1, val3);
  ...
  cc_array_list_merge(list1, list2);

  TEST_ASSERT_EQUAL(6, cc_array_list_length(list1));

  cc_object *ret1 = cc_array_list_get(list1, 0);
  cc_object *ret2 = cc_array_list_get(list1, 1);
  cc_object *ret3 = cc_array_list_get(list1, 2);
  cc_object *ret4 = cc_array_list_get(list1, 3);
  cc_object *ret5 = cc_array_list_get(list1, 4);
  cc_object *ret6 = cc_array_list_get(list1, 5);
...
void test_can_merge_empty_array_lists(void) {
  ...
  TEST_ASSERT_EQUAL(cc_array_list_length(a_list), cc_array_list_length(b_list));
  TEST_ASSERT_EQUAL(0, cc_array_list_length(a_list));
}
...
void test_can_create_array_list_from_cc_object(void) {
  ...
  cc_array_list *b_list = cc_array_list_from_object(object);

  TEST_ASSERT_NOT_EQUAL(NULL, b_list);
  TEST_ASSERT_EQUAL(count, cc_array_list_length(b_list));
