...
As mention in \autoref{sec:preface} the library will be made publicly available on \\\href{https://github.com/ksmandersen/CCollections}{github.com/ksmandersen/CCollections}. The library will be licensed under the GPL v3 license\footnote{More information on \url{http://www.tldrlegal.com/license/gnu-general-public-license-v3-(gpl-3)}}, making the software free to modify, distribute and use commercially.
